...
?>
	<table width="800" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
		<tr>
			<td><table width="100%" border="1" cellpadding="3" cellspacing="1">
				<tr>
					<td bgcolor="#ADD8E6"><strong><?php echo $rows['topic']; ?></strong></td>
				</tr>

				<tr>
					<td bgcolor="#ADD8E6"><?php echo $rows['detail']; ?></td>
				</tr>

				<tr>
					<td bgcolor="#ADD8E6"><strong>By :</strong> <?php echo $rows['name']; ?> <strong>Email : </strong><?php echo $rows['email'];?></td>
				</tr>

				<tr>
					<td bgcolor="#ADD8E6"><strong>Date/time : </strong><?php echo $rows['datetime']; ?></td>
				</tr>
			</table></td>
		</tr>
	</table>
