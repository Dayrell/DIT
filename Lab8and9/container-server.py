...
def containers_show(id):
    ...
    curl -s -X GET -H 'Accept: application/json' http://localhost:8080/containers/serene_colden | python -mjson.tool
    """
...
def containers_log(id):
    ...
    curl -s -X GET -H 'Accept: application/json' http://localhost:8080/containers/serene_colden/logs | python -mjson.tool
    """
...
def images_remove(id):
    ...
    curl -s -X DELETE -H 'Accept: application/json' http://localhost:8080/images/bbb4c0fc8e9d
    """
    docker('rmi', '-f', id)
    resp = '{"id": "%s"}' % id
    return Response(response=resp, mimetype="application/json")
...
def containers_remove(id):
    ...
    curl -s -X DELETE -H 'Accept: application/json' http://localhost:8080/containers/2b735de193ef
    """
    docker('rm', '-f', id)
    resp = '{"id": "%s"}' % id
    return Response(response=resp, mimetype="application/json")
